///<summary>
///ESPAÑOL: Contien los métodos que calculan el tamaño del vector, el primer cuartil, tercer cuartil
/// desviación cuartilar y el rango intercuartilar
///ENGLISH: It contains the methods that calculate the size of the vector, the first quartile, third quartile
/// quartile deviation and the interquartile range
///</summary>
///<remarks>
/// Requiere de las clases cuartiles y mediana | Requires the 'cuartiles' and 'mediana' classes
///</remarks>
