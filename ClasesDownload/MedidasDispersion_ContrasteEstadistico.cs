///<summary>
///ESPAÑOL: Contien el método que cálcula el contraste estadístico para ANOVA o ADEVA unifactorial
///ENGLISH: Contains the method that calculates the statistical contrast for ANOVA or unifactorial ADEVA
///</summary>
