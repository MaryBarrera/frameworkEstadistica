//ESPAÑOL: La clase contiene los metodos que calculan el limite de clases y el limite real de las clases
//ENGLISH: The class contains the methods that calculate the class limit and the actual limit of the classes
